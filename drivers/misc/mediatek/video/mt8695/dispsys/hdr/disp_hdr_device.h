...
#define BT2020_VERIFY_PLANE(plane) (((plane) >= BT2020_PLANE_MAX) || (plane < HDR2SDR_PLANE_MAIN))

#define SDR2HDR_VERIFY_PLANE(plane) (((plane) >= SDR2HDR_PLANE_MAX) || (plane < HDR2SDR_PLANE_MAIN))

#define HDR2SDR_VERIFY_PLANE(plane) (((plane) >= HDR2SDR_PLANE_MAX) || (plane < HDR2SDR_PLANE_MAIN))
